...
export default function PrintersRedirectPage() {
  const router = useRouter();
  useEffect(() => {
    router.replace('/printer/dashboard?tab=FLEET');
  }, [router]);
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center text-blue-600">
      <div className="text-center">
        ...
        <p className="text-xs font-bold text-slate-700">Loading Printer Fleet Manager...</p>
      </div>
    </div>
  );
}
